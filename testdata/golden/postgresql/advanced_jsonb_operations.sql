...
(metadata -> 'experience' ->> 'years')::integer as years_experience_int,
  ...
  metadata? | 'array' ['skills',
  'experience' ] as has_skills_or_experience,
  metadata? & 'array' ['profile',
  'skills' ] as has_profile_and_skills,
  metadata -> 'tags' ?'urgent' as has_urgent_tag,
  metadata -> 'tags' ?| 'array' ['urgent',
  'important' ] as has_urgent_or_important,
