...
var (
	postgreSQLReservedWords = []string{
	...
	postgreSQLReservedTopLevelWords = []string{
	...
	postgreSQLReservedTopLevelWordsNoIndent = []string{
		"INTERSECT ALL", "INTERSECT", "MINUS", "UNION ALL", "UNION",
	}

	postgreSQLReservedNewlineWords = []string{
