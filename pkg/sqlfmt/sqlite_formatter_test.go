...
// Phase 1 SQLite tests - Foundation implementation
func TestSQLitePhase1_BasicDialect(t *testing.T) {
...
func TestSQLitePhase1_TokenizerConfig(t *testing.T) {
...
func TestSQLitePhase1_FormatterCreation(t *testing.T) {
...
func TestSQLitePhase1_LanguageSelection(t *testing.T) {
...
// Test a few SQLite-specific features that work in Phase 1
func TestSQLitePhase1_BasicFeatures(t *testing.T) {
	cfg := &Config{Language: SQLite, Indent: "  "}
